...
import io.mishkav.voyager.core.utils.permissions.impl.utils.findActivity
...
@Composable
internal fun rememberVoyagerPermissionsController(): VoyagerPermissionsControllerImpl {
    ...
    return remember(
        ...
        VoyagerPermissionsControllerImpl(
...
internal class VoyagerPermissionsControllerImpl(
        ...
        val observer = object : LifecycleEventObserver {
            override fun onStateChanged(source: LifecycleOwner, event: Lifecycle.Event) {
                if (event == Lifecycle.Event.ON_DESTROY) {
                    this@VoyagerPermissionsControllerImpl.activityResultRegistryHolder.value = null
                    this@VoyagerPermissionsControllerImpl.launcherHolder.value = null
    ...
    override suspend fun isPermissionGranted(
        permission: Permission
    ): Boolean = getPermissionState(permission) == PermissionState.Granted
