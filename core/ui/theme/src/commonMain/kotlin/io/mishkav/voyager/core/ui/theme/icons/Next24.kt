...
val VoyagerIcon.next24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Next24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        ...
        group(
            ...
            path(
                ...
                moveTo(19.727f, 9.929f)
                curveTo(19.248f, 8.142f, 18.164f, 6.575f, 16.66f, 5.497f)
                curveTo(15.155f, 4.419f, 13.323f, 3.896f, 11.477f, 4.017f)
                curveTo(9.63f, 4.138f, 7.882f, 4.896f, 6.531f, 6.161f)
                curveTo(5.18f, 7.426f, 4.31f, 9.121f, 4.068f, 10.956f)
                curveTo(3.827f, 12.791f, 4.229f, 14.653f, 5.206f, 16.225f)
                curveTo(6.184f, 17.796f, 7.676f, 18.98f, 9.428f, 19.576f)
                curveTo(11.181f, 20.17f, 13.086f, 20.139f, 14.818f, 19.487f)
                curveTo(16.55f, 18.835f, 18.003f, 17.603f, 18.928f, 16f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 1.00088f,
                ...
                moveTo(21.035f, 6.136f)
                lineTo(20f, 10f)
                lineTo(16.136f, 8.965f)
            }
